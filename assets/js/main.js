...
function contentView(item) {
    ...
    let content = `<div class="cell large-3">
                        ${brand}<br>
                        ${product_name}<br>
                        <img src="${image_path}" alt="${product_name}"><br>

                        <span class="product-minus" data-id="${id}"> - </span>
                        
                        <span class="product-quantity" id="quantity_${id}">1</span>
    
                        <span class="product-plus" data-id="${id}"> + </span>

                        <br>

                        <input type="button" data-id="${id}" class="product-add-cart" value="ADD TO CART">
